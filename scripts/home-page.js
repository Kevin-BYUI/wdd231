const closeLink = document.querySelector('.close-links');
const openLink = document.querySelector('.open-links');
const navContainer = document.querySelector('.nav-container');

closeLink.addEventListener('click', () => {
    openLink.hidden = false;   // show open button
    closeLink.hidden = true;   // hide close button
    navContainer.classList.add('hidden')
});

openLink.addEventListener('click', () => {
    openLink.hidden = true;    // hide open button
    closeLink.hidden = false;  // show close button
...
function displayCourses(list) {
  ...
  count.textContent = `The total number of course listed below is ${list.length}`;
}
...
const currentYear = document.lastModified;
const yearPublished = document.querySelector('#current-year');
yearPublished.textContent = `Last Modified: ${currentYear}`;